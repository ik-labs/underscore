  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_#2f6d62,_#081714_52%,_#050807_100%)] px-6 py-10 text-stone-100">
      <div className="mx-auto max-w-6xl space-y-8">
        <header className="grid gap-5 rounded-[2rem] border border-white/10 bg-black/20 p-8 shadow-2xl shadow-black/10 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-4">
            ...
            <p className="max-w-2xl text-sm leading-7 text-stone-200/78">
              Build the prose corpus first. Upload scripts, notes, markdown, and
              subtitles so the retrieval layer has grounded material to work with.
            </p>
          </div>
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
            ...
            <div className="rounded-[1.5rem] border border-white/10 bg-white/6 px-5 py-4">
              ...
              <p className="mt-2 text-sm text-stone-100">
                {project.sourceCount} sources · {project.proseChunkCount} prose chunks
              </p>
            </div>
          </div>
        </header>
        ...
        <section className="grid gap-6 lg:grid-cols-[0.75fr_1.25fr]">
          <div className="rounded-[2rem] border border-white/10 bg-black/20 p-6">
            ...
            <div className="mt-5 space-y-4 text-sm text-stone-200/80">
              <div>
                <p className="font-medium text-stone-100">Prose namespace</p>
                <p className="mt-1 break-all">{project.proseNamespaceId}</p>
              </div>
              <div>
                <p className="font-medium text-stone-100">Sonic namespace</p>
                <p className="mt-1 break-all">{project.sonicNamespaceId}</p>
              </div>
            </div>
          </div>
